...
export function MerkleDropHero() {
  return (
    <section className="md:container md:mx-auto md:px-20 text-shutter-black-lighter md:py-20 pt-12 pb-0">
      <div className="hero-header items-center flex md:flex-row flex-col px-4">
        <div className="md:flex-1 sm:w-1/2 w-2/3 self-baseline pt-20 md:ml-0 pr-16">
          ...
          <div className="flex flex-row items-center">
            <LinkButton
              className={`md:px-8 px-6 py-4 my-8 bg-shutter-green text-shutter-black flex items-center justify-center hover:bg-shutter-dark-green transition duration-500 ease-in-out transition-all`}
              isDark
              label="Learn more"
